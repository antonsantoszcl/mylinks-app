    ...
    <>
      ...
      >
        ...
        <span
          ...
          className="flex-shrink-0 p-0.5 rounded text-slate-400 hover:text-red-500 hover:bg-red-50 transition-colors opacity-100 md:opacity-0 md:group-hover/contact:opacity-100"
        >
