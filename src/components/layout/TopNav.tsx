    ...
    <>
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="flex items-center gap-1 text-xs font-medium text-slate-600 hover:text-slate-800 transition-colors px-2.5 py-1 rounded-lg border border-slate-300 hover:bg-slate-100 bg-white/90 backdrop-blur-sm shadow-sm min-h-[36px]"
        >
