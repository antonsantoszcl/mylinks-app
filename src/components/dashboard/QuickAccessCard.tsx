  ...
  return (
    <div className="relative flex-shrink-0 group">
      <button
        ...
        className="absolute -top-1 -right-1 p-0.5 rounded-full bg-white border border-slate-200 text-slate-400 hover:text-red-600 hover:bg-red-50 opacity-0 group-hover:opacity-100 transition-opacity z-10"
      ...
      >
        ...
        <span className="text-xs font-medium text-slate-700 group-hover:text-primary-700 transition-colors whitespace-nowrap">
          {link.title}
        </span>
      </Link>
    </div>
