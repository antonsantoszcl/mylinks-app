  ...
  return (
    <>
      ...
      >
          ...
          <div className="flex items-center gap-2 min-w-0 flex-1">
            ...
            <div className="flex flex-col min-w-0 flex-1" data-no-dnd="true">
              {isEditingTitle ? (
                ...
                <h3
                  className="text-sm md:text-[13px] font-semibold cursor-text truncate text-slate-700 tracking-tight uppercase"
        ...
        {/* White body area */}
        <div
          className="mx-2 rounded-xl md:rounded-[10px] flex-1 overflow-y-auto [&:has([data-editing])]:overflow-visible custom-scrollbar p-2.5 card-body-inner"
        >
          {showAddLink && (
